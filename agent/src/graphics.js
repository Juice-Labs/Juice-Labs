    ...
    process.nextTick(() => {
      ...
      if (_windows) {
        ...
        try {
          ...
          // Non-nvidia support and display support is removed because it spins up the cpu and virus scanner when polled on a
          // continuous basis.

          /*          
          bus:'PCI'
          model:'NVIDIA GeForce RTX 2080 Ti'
          subDeviceId:'12A410DE'
          vendor:'NVIDIA'
          vram:11264
          vramDynamic:true
          */
